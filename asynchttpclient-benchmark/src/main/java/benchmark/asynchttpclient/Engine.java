...
public class Engine implements HttpClientEngine {
    ...
    public void createClient(String host, int port) {
        AsyncHttpClientConfig config = new DefaultAsyncHttpClientConfig.Builder().setMaxConnections(MAX_CONNECTION_POOL_SIZE)
                                                                                 .setConnectionTtl(-1)
                                                                                 .setSoLinger(0)
                                                                                 .setMaxConnectionsPerHost(MAX_CONNECTION_POOL_SIZE_PER_HOST)
                                                                                 .setRequestTimeout(READ_TIMEOUT)
